...
struct Inspection_Params
{
	...
	// --- CBMs --------------------------------------
	float fCBM_AbsMB_Meander = 1.0; 		// absolute MB value for Meander (in pixels)
	float fCBM_AbsSP_Meander = 1.0; 		// absolute SP value for Meander (in pixels)
	int   iCBM_Rmsize_Meander = 21;			// running median sizes for Meander (in pixels)
	float fCBM_AbsMB_Pad = 1.0; 			// absolute MB value for Pad (in pixels)
	float fCBM_AbsSP_Pad = 1.0; 			// absolute SP value for Pad (in pixels)
	int   iCBM_Rmsize_Pad = 15;				// running median sizes for Pad (in pixels)
	float fCBM_AbsMB_ConnPad = 1.0; 		// absolute MB value for Connnected Pad (in pixels)
	float fCBM_AbsSP_ConnPad = 1.0; 		// absolute SP value for Connnected Pad (in pixels)
	int   iCBM_Rmsize_ConnPad = 15;			// running median sizes for Connnected Pad (in pixels)
	float fCBM_AbsMB_WireAngle = 1.0; 		// absolute MB value for Wire Angle (in pixels)
	float fCBM_AbsSP_WireAngle = 1.0; 		// absolute SP value for Wire Angle (in pixels)
	...
	int iDt_Bright_Space = 20; 				// Bright deviation for space (GV)
	int iDt_Mean_Space = 21; 				// Mean filter size (in pixels)
	int iDt_Margin_Space = 5; 				// Expansion bounary margin (in pixels)
