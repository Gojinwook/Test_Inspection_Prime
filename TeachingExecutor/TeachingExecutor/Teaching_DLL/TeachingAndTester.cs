...
public partial class HDevelopExport
{
        ...
        HTuple hv_elengthnoend, HTuple hv_jpadd)
    {
        ...
        HObject ho_CircJP, ho_CircJPu, ho_SkeletonGd, ho_NoSkeletonG;
        HObject ho_SelectedSkeletonG = null, ho_SelectedSkeletonsG = null;
        HObject ho_SSG = null, ho_SelectedContourG = null, ho_RegionSCG = null;
        HObject ho_ER1 = null, ho_ER2 = null, ho_Circle = null, ho_RegionIntersection = null;
        HObject ho_P = null, ho_Pe = null, ho_Rectangle21 = null, ho_Rectangle22 = null;
        ...
        HOperatorSet.GenEmptyObj(out ho_NoSkeletonG);
        ...
        HOperatorSet.GenEmptyObj(out ho_P);
        HOperatorSet.GenEmptyObj(out ho_Pe);
        ...
        HOperatorSet.DilationCircle(ho_SkeletonG, out ho_SkeletonGd, 1);
        ho_NoSkeletonG.Dispose();
        HOperatorSet.Difference(ho_Domain, ho_SkeletonGd, out ho_NoSkeletonG);
        //get_region_points (JuncPoints, RowsJP, ColsJP)
        HTuple end_val36 = hv_nFWM;
        HTuple step_val36 = 1;
        for (hv_k = 1; hv_k.Continue(end_val36, step_val36); hv_k = hv_k.TupleAdd(step_val36))
        {
            //if (k==65)
            //stop ()
            //endif
            ...
            HTuple end_val44 = hv_nSSG;
            HTuple step_val44 = 1;
            for (hv_kk = 1; hv_kk.Continue(end_val44, step_val44); hv_kk = hv_kk.TupleAdd(step_val44))
            {
                ho_SSG.Dispose();
                ...
                HOperatorSet.GenContoursSkeletonXld(ho_SSG, out ho_SelectedContourG, 1, "filter");
                ...
                HOperatorSet.GenRegionPoints(out ho_ER1, hv_RowG.TupleSelect(0), hv_ColG.TupleSelect(
                    0));
                ho_ER2.Dispose();
                HOperatorSet.GenRegionPoints(out ho_ER2, hv_RowG.TupleSelect(hv_nA - 1), hv_ColG.TupleSelect(
                    hv_nA - 1));
                if ((int)(new HTuple(hv_a.TupleGreater(0))) != 0)
                {
                    ...
                    if ((int)(new HTuple(hv_IsSubset.TupleLessEqual(1))) != 0)
                    {
                        ...
                        ho_P.Dispose();
                        HOperatorSet.GenRegionPoints(out ho_P, hv_RowG.TupleSelect(0), hv_ColG.TupleSelect(
                            0));
                        ho_Pe.Dispose();
                        HOperatorSet.ExpandRegion(ho_P, ho_NoSkeletonG, out ho_Pe, hv_elengthnoend.TupleAbs()
                            , "image");

                        //set_system ('neighborhood', nb)
                        if ((int)(new HTuple(hv_elengthnoend.TupleGreater(0))) != 0)
                        {
                            {
                                HObject ExpTmpOutVar_0;
                                HOperatorSet.Union2(ho_SelectedSkeletonG, ho_RegionIntersection, out ExpTmpOutVar_0
                                    );
                                ho_SelectedSkeletonG.Dispose();
                        ...
                        {
                            //difference (SelectedSkeletonG, RegionIntersection, SelectedSkeletonG)
                            {
                                HObject ExpTmpOutVar_0;
                                HOperatorSet.Difference(ho_SelectedSkeletonG, ho_Pe, out ExpTmpOutVar_0
                                    );
                                ho_SelectedSkeletonG.Dispose();
                                ho_SelectedSkeletonG = ExpTmpOutVar_0;
                            }
                    ...
                    {
                        ho_Circle.Dispose();
                        HOperatorSet.GenCircle(out ho_Circle, hv_RowG.TupleSelect(hv_nA - 1), hv_ColG.TupleSelect(
                            hv_nA - 1), hv_elengthnoend.TupleAbs());
                        ho_RegionIntersection.Dispose();
                        HOperatorSet.Intersection(ho_Circle, ho_SkeletonG, out ho_RegionIntersection
                            );
                        ho_P.Dispose();
                        HOperatorSet.GenRegionPoints(out ho_P, hv_RowG.TupleSelect(hv_nA - 1),
    ...
    public void FindWidth(HTuple hv_WGi, HTuple hv_wside, out HTuple hv_Width)
    {
        ...
        HTuple hv_nP = null, hv_FPrcWGi = null, hv_FPrcWGism = null;
        HTuple hv_MinPrcWG = null, hv_MaxPrcWG = null, hv_YMinPrcWG = null;
        HTuple hv_YMaxPrcWG = null, hv_nMax = null, hv_nMin = null;
        HTuple hv_Seq = null, hv_Indices = null, hv_Sorted = null;
        HTuple hv_Inverted1 = null, hv_Inverted = null, hv_j = null;
        HTuple hv_y = new HTuple(), hv_MaxIndi = null, hv_nMaxInd = null;
        HTuple hv_MaxInd = null, hv_jj = new HTuple(), hv_curMaxInd = new HTuple();
        HTuple hv_jp = new HTuple(), hv_prevMaxInd = new HTuple();
        ...
        HOperatorSet.SmoothFunct1dMean(hv_FPrcWGi, 3, 1, out hv_FPrcWGism);
        HOperatorSet.LocalMinMaxFunct1d(hv_FPrcWGism, "plateaus_center", "true", out hv_MinPrcWG,
            out hv_MaxPrcWG);
        ...
        for (hv_j = 0; hv_j.Continue(end_val19, step_val19); hv_j = hv_j.TupleAdd(step_val19))
        {
            ...
            if ((int)(new HTuple(hv_y.TupleLess(6))) != 0)
            {
                break;
            }
        }
        ...
        else
        {
            ...
            for (hv_j = 0; hv_j.Continue(end_val32, step_val32); hv_j = hv_j.TupleAdd(step_val32))
            {
                ...
                hv_prevMaxInd = hv_MaxInd.TupleSelect(hv_jp);
                ...
                if ((int)(new HTuple(hv_difind.TupleLess(hv_wside))) != 0)
                {
                    ...
                    HTuple end_val44 = hv_nMaxInd - 1;
                    HTuple step_val44 = 1;
                    for (hv_jj = hv_j + 1; hv_jj.Continue(end_val44, step_val44); hv_jj = hv_jj.TupleAdd(step_val44))
                    {
        ...
        HTuple hv_wpl, HTuple hv_sgap, out HTuple hv_nTr)
    {
        ...
        for (hv_j = 1; hv_j.Continue(end_val31, step_val31); hv_j = hv_j.TupleAdd(step_val31))
        {
            ...
            HOperatorSet.GenRegionLine(out ho_RegionsLines, hv_Y1.TupleSelect(hv_k), hv_X1.TupleSelect(
                hv_k), hv_Y2.TupleSelect(hv_k), hv_X2.TupleSelect(hv_k));
            ...
            for (hv_k = 0; hv_k.Continue(end_val77, step_val77); hv_k = hv_k.TupleAdd(step_val77))
            {
                ...
                HOperatorSet.GenRegionLine(out ho_RegionLine, hv_Y1.TupleSelect(hv_k), hv_X1.TupleSelect(
                    hv_k), hv_Y2.TupleSelect(hv_k), hv_X2.TupleSelect(hv_k));
        ...
        out HTuple hv_PcontR, out HTuple hv_Puseint)
    {
        ...
        HTuple hv_lpnum2 = null, hv_pnump = null, hv_pnumc = new HTuple();
        HTuple hv_Dir = null, hv_Ang = null, hv_K = null;
        // Initialize local and output iconic variables 
        ...
        HTuple end_val136 = hv_nPnum - 1;
        HTuple step_val136 = 1;
        for (hv_j = 0; hv_j.Continue(end_val136, step_val136); hv_j = hv_j.TupleAdd(step_val136))
        {
            if (hv_Pnum2 == null)
                hv_Pnum2 = new HTuple();
            hv_Pnum2[hv_j] = -1;
        ...
        HTuple end_val140 = hv_nPnum - 1;
        HTuple step_val140 = 1;
        for (hv_j = hv_lpnum2; hv_j.Continue(end_val140, step_val140); hv_j = hv_j.TupleAdd(step_val140))
        {
            hv_pnumc = hv_Pnum.TupleSelect(hv_j);
            if ((int)(new HTuple(hv_pnumc.TupleNotEqual(hv_pnump))) != 0)
            {
                HTuple end_val143 = hv_lpnum2;
                HTuple step_val143 = 1;
                for (hv_jj = 1; hv_jj.Continue(end_val143, step_val143); hv_jj = hv_jj.TupleAdd(step_val143))
                {
                    if (hv_Pnum2 == null)
                        hv_Pnum2 = new HTuple();
    ...
    public void MSBuildFWM53(HObject ho_SkeletonsGThin, HObject ho_WidthImageP, HObject ho_DirImageP,
        HObject ho_ImageIR, HTuple hv_wpl, HTuple hv_notusedint, HTuple hv_lpnum2, out HTuple hv_Pnum,
        out HTuple hv_Pnum2, out HTuple hv_PnumR, out HTuple hv_Y1, out HTuple hv_X1,
        out HTuple hv_Y2, out HTuple hv_X2, out HTuple hv_PaddrC, out HTuple hv_PaddrR,
        out HTuple hv_YC, out HTuple hv_XC, out HTuple hv_WG, out HTuple hv_PregC, out HTuple hv_PCinRnum,
        out HTuple hv_PcontR, out HTuple hv_Puseint)
        ...
        out HTuple hv_WGN, out HTuple hv_PregCN, out HTuple hv_PCinRnumN, out HTuple hv_PcontRN)
    {
        ...
        HOperatorSet.ExpandRegion(ho_SkeletonFWM, ho_Forb, out ho_RegionExpandedi, 50,
            "image");
        ...
        HTuple end_val70 = hv_nNFWMcad;
        HTuple step_val70 = 1;
        for (hv_j = 1; hv_j.Continue(end_val70, step_val70); hv_j = hv_j.TupleAdd(step_val70))
        {
            ho_Obj.Dispose();
            ...
            HTuple end_val85 = hv_nCo;
            HTuple step_val85 = 1;
            for (hv_jj = 1; hv_jj.Continue(end_val85, step_val85); hv_jj = hv_jj.TupleAdd(step_val85))
            {
                ho_Contour.Dispose();
                ...
                hv_n = hv_pN / 6;
                HOperatorSet.TestRegionPoint(ho_RegionsNFWM, hv_Y1t.TupleSelect(hv_n), hv_X1t.TupleSelect(
                    hv_n), out hv_IsInside1);
        ...
        out HObject ho_DirImageS, HTuple hv_WidthG, HTuple hv_HeightG)
    {
        ...
        HOperatorSet.GenContoursSkeletonXld(ho_SkeletonGS, out ho_SkContoursGS, 10, "filter");
        //dev_update_off ()
    ...
    public void Unwrap(HTuple hv_DSk, HTuple hv_cyc, out HTuple hv_DSku)
    {
        ...
        HTuple hv_n = null, hv_dp = null, hv_i = null;
        HTuple hv_d = new HTuple(), hv_dif = new HTuple();
        // Initialize local and output iconic variables 
        HOperatorSet.TupleLength(hv_DSk, out hv_n);
        hv_DSku = new HTuple();
        hv_dp = hv_DSk.TupleSelect(0);
        HTuple end_val3 = hv_n - 1;
        HTuple step_val3 = 1;
        for (hv_i = 0; hv_i.Continue(end_val3, step_val3); hv_i = hv_i.TupleAdd(step_val3))
        {
            hv_d = hv_DSk.TupleSelect(hv_i);
            //dp := DSk[i-1]
            hv_dif = hv_d - hv_dp;
            if ((int)(new HTuple(hv_dif.TupleLess((-hv_cyc) / 2))) != 0)
            {
                if (hv_DSku == null)
                    hv_DSku = new HTuple();
                hv_DSku[hv_i] = (hv_DSk.TupleSelect(hv_i)) + hv_cyc;
            }
            else if ((int)(new HTuple(hv_dif.TupleGreater(128))) != 0)
            {
                if (hv_DSku == null)
                    hv_DSku = new HTuple();
                hv_DSku[hv_i] = (hv_DSk.TupleSelect(hv_i)) - hv_cyc;
            ...
            hv_dp = hv_DSku.TupleSelect(hv_i);
        }

        return;
    }

    public void TeachingMain129(HObject ho_RegNoProc, HObject ho_Gi, HObject ho_Im,
        ...
        HTuple hv_useODB, HTuple hv_autowidth, HTuple hv_EPexp, HTuple hv_elongLG, HTuple hv_minPSklen,
        HTuple hv_lpnum2, out HTuple hv_nFWM, out HTuple hv_nFWMS, out HTuple hv_nNonWFM,
        out HTuple hv_WG, out HTuple hv_YC, out HTuple hv_XC, out HTuple hv_Y1, out HTuple hv_X1,
        out HTuple hv_Y2, out HTuple hv_X2, out HTuple hv_Pnum, out HTuple hv_Pnum2,
        out HTuple hv_PnumR, out HTuple hv_PregC, out HTuple hv_PcontR, out HTuple hv_PaddrR,
        out HTuple hv_PaddrC, out HTuple hv_PCinRnum, out HTuple hv_PuseintP, out HTuple hv_WGS,
        out HTuple hv_YCS, out HTuple hv_XCS, out HTuple hv_Y1S, out HTuple hv_X1S,
        out HTuple hv_Y2S, out HTuple hv_X2S, out HTuple hv_PnumS, out HTuple hv_PnumS2,
        out HTuple hv_PnumRS, out HTuple hv_PregCS, out HTuple hv_PcontRS, out HTuple hv_PaddrRS,
        out HTuple hv_PaddrCS, out HTuple hv_PCinRnumS, out HTuple hv_PuseintS, out HTuple hv_SequenceIRB,
        out HTuple hv_SequenceIRBS, out HTuple hv_WGN, out HTuple hv_YCN, out HTuple hv_XCN,
        out HTuple hv_Y1N, out HTuple hv_X1N, out HTuple hv_Y2N, out HTuple hv_X2N,
        out HTuple hv_PnumN, out HTuple hv_PnumRN, out HTuple hv_PregCN, out HTuple hv_PcontRN,
        out HTuple hv_PaddrRN, out HTuple hv_PaddrCN, out HTuple hv_PCinRnumN, out HTuple hv_TotalPRC,
        out HTuple hv_CurrentOper)
    {
        ...
        HObject ho_RegionIntersection1, ho_SkeletonLG, ho_EndPointsMSS = null;
        HObject ho_JuncPointsMSS = null, ho_EndPointsMSSu = null, ho_CMSSE = null;
        HObject ho_CMSSEu = null, ho_SkeletonPartsPinc, ho_WidthImagePout;
        HObject ho_DirImagePout, ho_RegForbid, ho_RegionsPNii, ho_AngleImageP;
        HObject ho_DistGPi, ho_DistGSi, ho_DistGSii, ho_DistGP;
        HObject ho_DistGS, ho_ImDisplacementi, ho_Rd, ho_JP, ho_CJ = null;
        HObject ho_Skeletonii = null, ho_SkeletonsWire = null, ho_Rnoint = null;
        HObject ho_Rmain = null, ho_ConnectedRegions = null, ho_RegionsmainNoCut = null;
        HObject ho_RegionmainNoCut = null, ho_Regionsmain, ho_Regionmain;
        HObject ho_Regionmaini, ho_SkeletonsFWMii, ho_PC, ho_SkeletonPartsPi = null;
        HObject ho_RegionsmainPNPi, ho_SkeletonPartsPii, ho_RmainS;
        HObject ho_EndPointsS, ho_JuncPointsS, ho_JuncPointsSu;
        HObject ho_CirclesSJ = null, ho_CirclesSJu = null, ho_RmainSnoJ = null;
        HObject ho_RegionsmainSs = null, ho_RegionsmainSu = null, ho_RegionsmainSuc = null;
        HObject ho_RegionsmainSn = null, ho_EndPointsSN, ho_JuncPointsSN;
        HObject ho_RegionDilationSN, ho_RegionsmainS, ho_RegionmainSNoCut;
        HObject ho_RegionmainS, ho_Sk = null, ho_RegionGND, ho_RegionGNDC;
        HObject ho_RegionsNFWMBcut, ho_RegionsNFWMs, ho_Region1;
        HObject ho_Region2, ho_ImageIRBS, ho_ImageIRS16, ho_RegForbidS;
        HObject ho_EndPoints, ho_JuncPoints, ho_EP, ho_SkeletonsFWMp;
        HObject ho_CE2, ho_SkeletonsFWMSii, ho_EPS, ho_CES, ho_SkeletonsFWMSi;
        HObject ho_RegionsPNSii, ho_RegionEMPTY, ho_RegionEMPTYC;
        HObject ho_SkeletonsFWMSrc, ho_PCS;
        ...
        HTuple hv_RJ = null, hv_nFWMPS = null, hv_cut = null, hv_cyc = null;
        HTuple hv_RowsSk = new HTuple(), hv_ColumnsSk = new HTuple();
        HTuple hv_DSk = new HTuple(), hv_DSku = new HTuple(), hv_dSkumin = new HTuple();
        HTuple hv_dSkumax = new HTuple(), hv_dSkuspan = new HTuple();
        HTuple hv_nINB = null, hv_SequenceINBi = null, hv_PnumRN1 = null;
        HTuple hv_WN = null, hv_AreaNFWMs = null, hv_Row = null;
        HTuple hv_Column = null, hv_RowsE = null, hv_ColumnsE = null;
        HTuple hv_nE = null, hv_nFWMs = null, hv_Erad2 = null;
        HTuple hv_RowsES = null, hv_ColumnsES = null, hv_nES = null;
        HTuple hv_EradS = null, hv_nINBS = null, hv_SequenceINBSi = null;
        HTuple hv_useint = null;
        ...
        HOperatorSet.GenEmptyObj(out ho_EndPointsSN);
        HOperatorSet.GenEmptyObj(out ho_JuncPointsSN);
        HOperatorSet.GenEmptyObj(out ho_RegionDilationSN);
        ...
        //smallest_rectangle1(RC, Row1, Column1, Row2, Column2)ImIRBS:= ImageIRBS
        //Column2 := Column2-5
        ...
        //** Old LG
        //if (elongLG >0)
        //junctions_skeleton (SkeletonGS, EndPointsGS, JuncPointsGS)
        //dilation_circle (EndPointsGS, RegionDilationGS, elongLG)
        //intersection (SkeletonGSi, RegionDilationGS, RegionIntersection1)
        //union2 (SkeletonGS, RegionIntersection1, SkeletonLG)
        //connection (SkeletonLG, SkeletonsLG)
        //endif
        //    union2
        //* elseif(cutendMSS >0)    
        HTuple end_val189 = hv_cutendMSS;
        HTuple step_val189 = 1;
        for (hv_j = 1; hv_j.Continue(end_val189, step_val189); hv_j = hv_j.TupleAdd(step_val189))
        {
        ...
        SpaceWidthDirImages(ho_RegionGSii, ho_SkeletonGS, out ho_WidthImageS, out ho_DirImageS,
        ...
        hv_minlen = hv_minPSklen.Clone();
        {
            HObject ExpTmpOutVar_0;
            HOperatorSet.Pruning(ho_SkeletonG, out ExpTmpOutVar_0, 10);
            ho_SkeletonG.Dispose();
            ho_SkeletonG = ExpTmpOutVar_0;
        }
        ho_EndPointsG.Dispose(); ho_JuncPointsG.Dispose();
        ...
        HTuple end_val296 = hv_nWGi - 1;
        HTuple step_val296 = 1;
        for (hv_j = 0; hv_j.Continue(end_val296, step_val296); hv_j = hv_j.TupleAdd(step_val296))
        {
        ...
        if ((int)(new HTuple(hv_useODB.TupleEqual(0))) != 0)
        {
            ...
            hv_RowsT = new HTuple();
            hv_ColsT = new HTuple();
            HTuple end_val410 = hv_nWGi - 1;
            HTuple step_val410 = 1;
            for (hv_j = 0; hv_j.Continue(end_val410, step_val410); hv_j = hv_j.TupleAdd(step_val410))
            {

                hv_w = hv_WGi.TupleSelect(hv_j);
                HTuple end_val413 = hv_nWP - 1;
                HTuple step_val413 = 1;
                for (hv_k = 0; hv_k.Continue(end_val413, step_val413); hv_k = hv_k.TupleAdd(step_val413))
                {
        ...
        ExtendedSkeletonWFMP5(ho_RegionG, ho_RegionsmainNoCut, ho_SkeletonG, ho_WidthImageP,
        ...
        HTuple end_val660 = hv_nWGSi - 1;
        HTuple step_val660 = 1;
        for (hv_j = 0; hv_j.Continue(end_val660, step_val660); hv_j = hv_j.TupleAdd(step_val660))
        {
            hv_w = hv_WGSi.TupleSelect(hv_j);
            //if (RowsGSi[j]==894 and ColsGSi[j]==9086)
            //stop ()
            //endif
            HTuple end_val665 = hv_nWS - 1;
            HTuple step_val665 = 1;
            for (hv_k = 0; hv_k.Continue(end_val665, step_val665); hv_k = hv_k.TupleAdd(step_val665))
            {
        ...
        //tuple_gen_const (nMSS, 1, RadendMSS)
        //*** New LG ******
        ho_EndPointsSN.Dispose(); ho_JuncPointsSN.Dispose();
        HOperatorSet.JunctionsSkeleton(ho_RegionsmainSNoCut, out ho_EndPointsSN, out ho_JuncPointsSN
            );
        ho_RegionDilationSN.Dispose();
        HOperatorSet.DilationCircle(ho_EndPointsSN, out ho_RegionDilationSN, hv_elongLG);
        ho_RegionIntersection1.Dispose();
        HOperatorSet.Intersection(ho_SkeletonGSi, ho_RegionDilationSN, out ho_RegionIntersection1
            );
        ho_SkeletonLG.Dispose();
        HOperatorSet.Union2(ho_RegionsmainSNoCut, ho_RegionIntersection1, out ho_SkeletonLG
            );
        ho_SkeletonsLG.Dispose();
        HOperatorSet.Connection(ho_SkeletonLG, out ho_SkeletonsLG);

        //************
        HTuple end_val726 = hv_cutendMSS;
        HTuple step_val726 = 1;
        for (hv_j = 1; hv_j.Continue(end_val726, step_val726); hv_j = hv_j.TupleAdd(step_val726))
        {
            //j := 585
            ho_EndPointsMSS.Dispose(); ho_JuncPointsMSS.Dispose();
        ...
        hv_cut = 0;
        hv_cyc = 255;
        HTuple end_val758 = hv_nFWMS;
        HTuple step_val758 = 1;
        for (hv_j = 1; hv_j.Continue(end_val758, step_val758); hv_j = hv_j.TupleAdd(step_val758))
        {
            ho_Sk.Dispose();
            HOperatorSet.SelectObj(ho_SkeletonsFWMS, out ho_Sk, hv_j);
            HOperatorSet.GetRegionPoints(ho_Sk, out hv_RowsSk, out hv_ColumnsSk);
            HOperatorSet.GetGrayval(ho_DirImageS, hv_RowsSk, hv_ColumnsSk, out hv_DSk);
            //unwrapping DSk
            Unwrap(hv_DSk, hv_cyc, out hv_DSku);
            //****
            HOperatorSet.TupleMin(hv_DSku, out hv_dSkumin);
            HOperatorSet.TupleMax(hv_DSku, out hv_dSkumax);
            hv_dSkuspan = hv_dSkumax - hv_dSkumin;

            if ((int)(new HTuple(hv_dSkuspan.TupleGreater(250))) != 0)
            {
                hv_cut = 1;
            }
        }
        if ((int)(new HTuple(hv_cut.TupleEqual(0))) != 0)
        {
            ho_RegionCut.Dispose();
            HOperatorSet.GenEmptyObj(out ho_RegionCut);
            ho_SkeletonsFWMScut.Dispose();
            ho_SkeletonsFWMScut = ho_SkeletonsFWMS.CopyObj(1, -1);
        }
        ...
        //lpnum2 := 30
        MSBuildFWM53(ho_SkeletonsFWM, ho_WidthImageP, ho_DirImageP, ho_ImageIR16, hv_wpl,
            hv_useint, hv_lpnum2, out hv_Pnum, out hv_Pnum2, out hv_PnumR, out hv_Y1,
            out hv_X1, out hv_Y2, out hv_X2, out hv_PaddrC, out hv_PaddrR, out hv_YC,
            out hv_XC, out hv_WG, out hv_PregC, out hv_PCinRnum, out hv_PcontR, out hv_PuseintP);
        ...
        ho_RegionsmainSuc.Dispose();
        ho_RegionsmainSn.Dispose();
        ho_EndPointsSN.Dispose();
        ho_JuncPointsSN.Dispose();
        ho_RegionDilationSN.Dispose();
        ho_RegionsmainS.Dispose();
        ho_RegionmainSNoCut.Dispose();
        ho_RegionmainS.Dispose();
